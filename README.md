...
13,011 events. 10,847 dead, 3,886 missing. No API keys, no build step, no
...
| | |
|---|---|
| Events | 13,011 (1971 – present) |
| Deaths / missing | 10,847 / 3,886 |
| Sources | BIPAD 6,707 · DesInventar 6,333 · curated 1 |
| Exactly located | 6,707 (52%) — the rest sit on a village or district centroid |
...
DesInventar between them emit `landslide` (7,357), `flood` (5,497) and
